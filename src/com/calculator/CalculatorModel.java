...
public class CalculatorModel implements CalculatorModelCallBack {
	...
	private CalculatorModelControllerCallBack controller;
	...
	CalculatorModel(CalculatorController controller) {
		this.controller = controller;
	}

	interface CalculatorModelControllerCallBack {

		void result(String soln, float result);

		void result(String result, String expression);
	...
	public void expression(String expression) {
		...
		controller.result(expression, no1);
	}
}